...
<!DOCTYPE html><html>
    <head>
        ...
        <form method="post" action="update-profile-action.php?user=<?php echo $user_data['username'] ?>" enctype="multipart/form-data">            
        <label>Name:</label><br>            
        ...
        <input type="file" name="image" id="fileToUpload" value='<?php echo $user_data['Image']?>'><br><br>
